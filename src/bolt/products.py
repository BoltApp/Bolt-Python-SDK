...
from bolt import errors, models, utils
from bolt._hooks import HookContext
...
class Products(BaseSDK):
    def create(
        ...
        *,
        ...
        unit_price: int,
        plans: Union[
            List[models.CreateProductPlan], List[models.CreateProductPlanTypedDict]
        ],
        ...
        request = models.CreateProductRequest(
            ...
            images=images,
            plans=utils.get_pydantic_model(plans, List[models.CreateProductPlan]),
        )
