...
class BoltOAuth(BaseSDK):
    ...
    def o_auth_token(
        self,
        *,
        security: Union[models.OAuthTokenSecurity, models.OAuthTokenSecurityTypedDict],
    ...
    ) -> models.OneDot0Dot1OAuthTokenResponse:
        ...
        **Reminder - the Content-Type of this request must be application/x-www-form-urlencoded**
        ...
        if server_url is not None:
            ...
            base_url = models.O_AUTH_TOKEN_OP_SERVERS[0]
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(security, models.OAuthTokenSecurity),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.OneDot0Dot1OAuthTokenResponse, http_res
            )
        if utils.match_response(http_res, ["400", "403", "422"], "application/json"):
            response_data = unmarshal_json_response(
                errors.OneDot0Dot1ErrorsOauthServerResponseData, http_res
            )
            raise errors.OneDot0Dot1ErrorsOauthServerResponse(response_data, http_res)
