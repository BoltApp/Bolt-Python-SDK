...
class BoltTransactions(BaseSDK):
    ...
    def authorize_transaction(
    ...
    ) -> models.OneDot0Dot1IAuthorizeResultView:
        r"""Authorize a Card
        ...
        *  • Re-charge a previous transaction using the `credit_card_id` of the transaction.
        ...
        if server_url is not None:
            ...
            base_url = models.AUTHORIZE_TRANSACTION_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.OneDot0Dot1IAuthorizeResultView, http_res
            )
    ...
    def capture_transaction(
        ...
        *,
        idempotency_key: Optional[str] = None,
        one_dot_0_dot_1_capture_transaction_with_reference: Optional[
            Union[
                models.OneDot0Dot1CaptureTransactionWithReference,
                models.OneDot0Dot1CaptureTransactionWithReferenceTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.OneDot0Dot1TransactionView:
        ...
        :param idempotency_key: A key created by merchants that ensures `POST` and `PATCH` requests are only performed once. [Read more about Idempotent Requests here](/developers/references/idempotency/).
        :param one_dot_0_dot_1_capture_transaction_with_reference: Capture a Transaction
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        if server_url is not None:
            ...
            base_url = models.CAPTURE_TRANSACTION_OP_SERVERS[0]

        request = models.CaptureTransactionRequest(
            idempotency_key=idempotency_key,
            one_dot_0_dot_1_capture_transaction_with_reference=utils.get_pydantic_model(
                one_dot_0_dot_1_capture_transaction_with_reference,
                Optional[models.OneDot0Dot1CaptureTransactionWithReference],
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.one_dot_0_dot_1_capture_transaction_with_reference,
                False,
                True,
                "json",
                Optional[models.OneDot0Dot1CaptureTransactionWithReference],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.OneDot0Dot1TransactionView, http_res)
        if utils.match_response(http_res, ["403", "404"], "application/json"):
            response_data = unmarshal_json_response(
                errors.OneDot0Dot1ErrorsBoltAPIResponseData, http_res
            )
            raise errors.OneDot0Dot1ErrorsBoltAPIResponse(response_data, http_res)
    ...
    def refund_transaction(
        ...
        *,
        idempotency_key: Optional[str] = None,
        one_dot_0_dot_1_transaction_credit: Optional[
            Union[
                models.OneDot0Dot1TransactionCredit,
                models.OneDot0Dot1TransactionCreditTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        :param idempotency_key: A key created by merchants that ensures `POST` and `PATCH` requests are only performed once. [Read more about Idempotent Requests here](/developers/references/idempotency/).
        :param one_dot_0_dot_1_transaction_credit: Refund a Transaction
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        if server_url is not None:
            ...
            base_url = models.REFUND_TRANSACTION_OP_SERVERS[0]

        request = models.RefundTransactionRequest(
            idempotency_key=idempotency_key,
            one_dot_0_dot_1_transaction_credit=utils.get_pydantic_model(
                one_dot_0_dot_1_transaction_credit,
                Optional[models.OneDot0Dot1TransactionCredit],
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.one_dot_0_dot_1_transaction_credit,
                False,
                True,
                "json",
                Optional[models.OneDot0Dot1TransactionCredit],
    ...
    def review_transaction(
        ...
        *,
        idempotency_key: Optional[str] = None,
        one_dot_0_dot_1_merchant_credit_card_review: Optional[
            Union[
                models.OneDot0Dot1MerchantCreditCardReview,
                models.OneDot0Dot1MerchantCreditCardReviewTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.OneDot0Dot1TransactionDetailsView:
        r"""Review Transaction

        This endpoint is used to manually approve or reject orders for a specified transaction.

        :param idempotency_key: A key created by merchants that ensures `POST` and `PATCH` requests are only performed once. [Read more about Idempotent Requests here](/developers/references/idempotency/).
        :param one_dot_0_dot_1_merchant_credit_card_review: Review a Transaction
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        if server_url is not None:
            ...
            base_url = models.REVIEW_TRANSACTION_OP_SERVERS[0]

        request = models.ReviewTransactionRequest(
            idempotency_key=idempotency_key,
            one_dot_0_dot_1_merchant_credit_card_review=utils.get_pydantic_model(
                one_dot_0_dot_1_merchant_credit_card_review,
                Optional[models.OneDot0Dot1MerchantCreditCardReview],
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.one_dot_0_dot_1_merchant_credit_card_review,
                False,
                True,
                "json",
                Optional[models.OneDot0Dot1MerchantCreditCardReview],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.OneDot0Dot1TransactionDetailsView, http_res
            )
    ...
    def void_transaction(
        ...
        *,
        idempotency_key: Optional[str] = None,
        one_dot_0_dot_1_credit_card_void: Optional[
            Union[
                models.OneDot0Dot1CreditCardVoid,
                models.OneDot0Dot1CreditCardVoidTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        :param idempotency_key: A key created by merchants that ensures `POST` and `PATCH` requests are only performed once. [Read more about Idempotent Requests here](/developers/references/idempotency/).
        :param one_dot_0_dot_1_credit_card_void: Void a Transaction
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        if server_url is not None:
            ...
            base_url = models.VOID_TRANSACTION_OP_SERVERS[0]

        request = models.VoidTransactionRequest(
            idempotency_key=idempotency_key,
            one_dot_0_dot_1_credit_card_void=utils.get_pydantic_model(
                one_dot_0_dot_1_credit_card_void,
                Optional[models.OneDot0Dot1CreditCardVoid],
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.one_dot_0_dot_1_credit_card_void,
                False,
                True,
                "json",
                Optional[models.OneDot0Dot1CreditCardVoid],
    ...
    def get_transaction_details(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.OneDot0Dot1TransactionDetails:
        ...
        **Note**: All objects and fields marked `required` in the Transaction Details response are also **nullable**. This includes any sub-components (objects or fields) also marked `required`.
        ...
        if server_url is not None:
            ...
            base_url = models.GET_TRANSACTION_DETAILS_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.OneDot0Dot1TransactionDetails, http_res
            )
    ...
    def update_transaction(
        ...
        *,
        ...
        if server_url is not None:
            ...
            base_url = models.UPDATE_TRANSACTION_OP_SERVERS[0]

        request = models.UpdateTransactionRequest(
            reference=reference,
            idempotency_key=idempotency_key,
            one_dot_0_dot_1_transaction_update_input=models.OneDot0Dot1TransactionUpdateInput(
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.one_dot_0_dot_1_transaction_update_input,
                False,
                True,
                "json",
                Optional[models.OneDot0Dot1TransactionUpdateInput],
            ),
            timeout_ms=timeout_ms,
        )
