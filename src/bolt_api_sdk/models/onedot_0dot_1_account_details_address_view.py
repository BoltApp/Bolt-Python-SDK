...
class OneDot0Dot1AccountDetailsAddressViewPriority(str, Enum):
...
class OneDot0Dot1AccountDetailsAddressViewTypedDict(TypedDict):
    ...
    priority: NotRequired[Nullable[OneDot0Dot1AccountDetailsAddressViewPriority]]
    r"""The shopper-indicated priority of this address compared to other addresses on their account."""
...
class OneDot0Dot1AccountDetailsAddressView(BaseModel):
    r"""The address object returned in the response."""
    ...
    priority: OptionalNullable[OneDot0Dot1AccountDetailsAddressViewPriority] = UNSET
    r"""The shopper-indicated priority of this address compared to other addresses on their account."""
