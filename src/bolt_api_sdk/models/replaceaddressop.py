...
class ReplaceAddressSecurityTypedDict(TypedDict):
    o_auth: str
    x_api_key: str


class ReplaceAddressSecurity(BaseModel):
    o_auth: Annotated[
        str,
        FieldMetadata(
...
class ReplaceAddressRequestTypedDict(TypedDict):
    id: str
...
class ReplaceAddressRequest(BaseModel):
    id: Annotated[
...
class ReplaceAddressResponseTypedDict(TypedDict):
    ...
    priority: NotRequired[Nullable[ReplaceAddressPriority]]
    r"""The shopper-indicated priority of this address compared to other addresses on their account."""
...
class ReplaceAddressResponse(BaseModel):
    r"""The address object returned in the response."""
    ...
    priority: OptionalNullable[ReplaceAddressPriority] = UNSET
    r"""The shopper-indicated priority of this address compared to other addresses on their account."""
