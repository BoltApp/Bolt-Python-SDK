...
class OneDot0Dot1OAuthTokenInputRefreshGrantType(str, Enum):
...
class OneDot0Dot1OAuthTokenInputRefreshTypedDict(TypedDict):
    client_id: str
    r"""Merchant publishable key which can be found in the merchant dashboard"""
    client_secret: str
    r"""Your Bolt API Key."""
    grant_type: OneDot0Dot1OAuthTokenInputRefreshGrantType
    r"""The type of OAuth 2.0 grant being utilized.
...
class OneDot0Dot1OAuthTokenInputRefresh(BaseModel):
    ...
    grant_type: Annotated[
        OneDot0Dot1OAuthTokenInputRefreshGrantType, FieldMetadata(form=True)
    ]
    r"""The type of OAuth 2.0 grant being utilized.
