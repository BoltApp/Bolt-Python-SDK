...
POST_V1_SUBSCRIPTIONS_SUBSCRIPTION_ID_UNPAUSE_OP_SERVERS = [
...
class PostV1SubscriptionsSubscriptionIDUnpauseSecurityTypedDict(TypedDict):
    v1_x_api_key: NotRequired[str]
    v1_x_publishable_key: NotRequired[str]


class PostV1SubscriptionsSubscriptionIDUnpauseSecurity(BaseModel):
