...
class EditAddressSecurityTypedDict(TypedDict):
    o_auth: str
    x_api_key: str


class EditAddressSecurity(BaseModel):
    o_auth: Annotated[
        str,
        FieldMetadata(
...
class EditAddressRequestTypedDict(TypedDict):
    id: str
...
class EditAddressResponseTypedDict(TypedDict):
    ...
    priority: NotRequired[Nullable[EditAddressPriority]]
    r"""The shopper-indicated priority of this address compared to other addresses on their account."""
...
class EditAddressResponse(BaseModel):
    r"""The address object returned in the response."""
    ...
    priority: OptionalNullable[EditAddressPriority] = UNSET
    r"""The shopper-indicated priority of this address compared to other addresses on their account."""
