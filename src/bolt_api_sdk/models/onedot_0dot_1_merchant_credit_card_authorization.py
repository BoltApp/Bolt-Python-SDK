...
from .onedot_0dot_1_credit_card import (
    OneDot0Dot1CreditCard,
    OneDot0Dot1CreditCardTypedDict,
)
...
class OneDot0Dot1MerchantCreditCardAuthorizationSource(str, Enum):
    DIRECT_PAYMENTS = "direct_payments"


class OneDot0Dot1MerchantCreditCardAuthorizationTypedDict(TypedDict):
    ...
    credit_card: OneDot0Dot1CreditCardTypedDict
    ...
    source: OneDot0Dot1MerchantCreditCardAuthorizationSource
...
class OneDot0Dot1MerchantCreditCardAuthorization(BaseModel):
    r"""This request is used for authorizing a new, unsaved card."""
    ...
    credit_card: OneDot0Dot1CreditCard
    r"""The credit_card object is used to to pay for guest-checkout transactions or save payment method details to an account. Once saved, you can reference the credit card with the associated `credit_card_id` for future transactions. Add `billing_address` to this if storing a billing address for a returning shopper."""
