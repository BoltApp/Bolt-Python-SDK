...
class AddressViewPriority(str, Enum):
...
class AddressViewTypedDict(TypedDict):
    ...
    priority: NotRequired[Nullable[AddressViewPriority]]
    r"""The shopper-indicated priority of this address compared to other addresses on their account."""
...
class AddressView(BaseModel):
    ...
    priority: OptionalNullable[AddressViewPriority] = UNSET
    r"""The shopper-indicated priority of this address compared to other addresses on their account."""
