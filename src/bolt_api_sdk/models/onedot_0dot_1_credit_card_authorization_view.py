...
from .onedot_0dot_1_credit_card_authorization_reason import (
    OneDot0Dot1CreditCardAuthorizationReason,
)
from .onedot_0dot_1_credit_card_authorization_status import (
    OneDot0Dot1CreditCardAuthorizationStatus,
)
...
class OneDot0Dot1CreditCardAuthorizationViewTypedDict(TypedDict):
    ...
    reason: NotRequired[OneDot0Dot1CreditCardAuthorizationReason]
    ...
    * `10` - unsupported_payment_method
    ...
    """
    status: NotRequired[OneDot0Dot1CreditCardAuthorizationStatus]
...
class OneDot0Dot1CreditCardAuthorizationView(BaseModel):
    ...
    reason: Optional[OneDot0Dot1CreditCardAuthorizationReason] = None
    r"""The reason code explaining the authorization status.
    * `1` - none
    * `2` - invalid_amount
    * `3` - invalid_cvv
    ...
    * `10` - unsupported_payment_method
    ...
    status: Optional[OneDot0Dot1CreditCardAuthorizationStatus] = None
    r"""The status of the authorization request.
    * `1` - succeeded
    * `2` - declined
    * `3` - error
