...
from .onedot_0dot_1_cart_item_gift_option import (
    OneDot0Dot1CartItemGiftOption,
    OneDot0Dot1CartItemGiftOptionTypedDict,
)
from .onedot_0dot_1_cart_item_property import (
    OneDot0Dot1CartItemProperty,
    OneDot0Dot1CartItemPropertyTypedDict,
)
from .onedot_0dot_1_cart_shipment import (
    OneDot0Dot1CartShipment,
    OneDot0Dot1CartShipmentTypedDict,
)
from .onedot_0dot_1_i_cart_item_external_inputs import (
    OneDot0Dot1ICartItemExternalInputs,
    OneDot0Dot1ICartItemExternalInputsTypedDict,
)
...
class OneDot0Dot1CartItemShipmentType(str, Enum):
    UNKNOWN = "unknown"
...
class OneDot0Dot1CartItemType(str, Enum):
    UNKNOWN = "unknown"
    DIGITAL = "digital"
    PHYSICAL = "physical"
    BUNDLED = "bundled"
...
class OneDot0Dot1CartItemTypedDict(TypedDict):
    name: str
    quantity: float
    reference: str
    total_amount: float
    ...
    external_inputs: NotRequired[OneDot0Dot1ICartItemExternalInputsTypedDict]
    gift_option: NotRequired[OneDot0Dot1CartItemGiftOptionTypedDict]
    ...
    properties: NotRequired[List[OneDot0Dot1CartItemPropertyTypedDict]]
    shipment: NotRequired[OneDot0Dot1CartShipmentTypedDict]
    r"""A cart that is being prepared for shipment"""
    shipment_type: NotRequired[OneDot0Dot1CartItemShipmentType]
    ...
    type: NotRequired[OneDot0Dot1CartItemType]
...
class OneDot0Dot1CartItem(BaseModel):
    name: str
    ...
    external_inputs: Optional[OneDot0Dot1ICartItemExternalInputs] = None

    gift_option: Optional[OneDot0Dot1CartItemGiftOption] = None
    r"""Contains the gift option settings for wrapping and custom messages."""
    ...
    properties: Optional[List[OneDot0Dot1CartItemProperty]] = None

    shipment: Optional[OneDot0Dot1CartShipment] = None
    r"""A cart that is being prepared for shipment"""

    shipment_type: Optional[OneDot0Dot1CartItemShipmentType] = None
    ...
    type: Optional[OneDot0Dot1CartItemType] = None
