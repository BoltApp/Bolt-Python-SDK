...
from .onedot_0dot_1_account_identifier_status import OneDot0Dot1AccountIdentifierStatus
from bolt_api_sdk.types import BaseModel
from typing import Optional
from typing_extensions import NotRequired, TypedDict


class OneDot0Dot1TestingAccountRequestTypedDict(TypedDict):
    ...
    email_state: NotRequired[OneDot0Dot1AccountIdentifierStatus]
    ...
    phone_state: NotRequired[OneDot0Dot1AccountIdentifierStatus]
    r"""The status of the shopper account identifier (email or phone). If the account does not have this identifier, the status is \"missing\"; If the identifier has been used to receive an OTP code, the status is \"verified\"; If the identifier has not been used to receive an OTP code, the status is \"unverified\"."""
...
class OneDot0Dot1TestingAccountRequest(BaseModel):
    ...
    email_state: Optional[OneDot0Dot1AccountIdentifierStatus] = None
    r"""The status of the shopper account identifier (email or phone). If the account does not have this identifier, the status is \"missing\"; If the identifier has been used to receive an OTP code, the status is \"verified\"; If the identifier has not been used to receive an OTP code, the status is \"unverified\"."""

    phone: Optional[str] = None
    r"""Deprecated. Please leave this field absent and let the API automatically generate a random phone number."""

    phone_state: Optional[OneDot0Dot1AccountIdentifierStatus] = None
    r"""The status of the shopper account identifier (email or phone). If the account does not have this identifier, the status is \"missing\"; If the identifier has been used to receive an OTP code, the status is \"verified\"; If the identifier has not been used to receive an OTP code, the status is \"unverified\"."""
