...
class AccountDetailsAddressViewPriority(str, Enum):
...
class AccountDetailsAddressViewTypedDict(TypedDict):
    ...
    priority: NotRequired[Nullable[AccountDetailsAddressViewPriority]]
    r"""The shopper-indicated priority of this address compared to other addresses on their account."""
...
class AccountDetailsAddressView(BaseModel):
    r"""The address object returned in the response."""
    ...
    priority: OptionalNullable[AccountDetailsAddressViewPriority] = UNSET
    r"""The shopper-indicated priority of this address compared to other addresses on their account."""
