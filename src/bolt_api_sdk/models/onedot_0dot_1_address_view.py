...
class OneDot0Dot1AddressViewPriority(str, Enum):
...
class OneDot0Dot1AddressViewTypedDict(TypedDict):
    ...
    priority: NotRequired[Nullable[OneDot0Dot1AddressViewPriority]]
    r"""The shopper-indicated priority of this address compared to other addresses on their account."""
...
class OneDot0Dot1AddressView(BaseModel):
    r"""The address object returned in the response."""
    ...
    priority: OptionalNullable[OneDot0Dot1AddressViewPriority] = UNSET
    r"""The shopper-indicated priority of this address compared to other addresses on their account."""
