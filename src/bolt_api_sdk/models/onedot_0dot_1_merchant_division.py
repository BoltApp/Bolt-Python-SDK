...
from .onedot_0dot_1_merchant_logo import (
    OneDot0Dot1MerchantLogo,
    OneDot0Dot1MerchantLogoTypedDict,
)
from .onedot_0dot_1_merchant_platform import OneDot0Dot1MerchantPlatform
...
class OneDot0Dot1MerchantDivisionTypedDict(TypedDict):
    description: str
    ...
    hook_type: NotRequired[OneDot0Dot1WebhooksType]
    ...
    logo: NotRequired[OneDot0Dot1MerchantLogoTypedDict]
    ...
    platform: NotRequired[OneDot0Dot1MerchantPlatform]
...
class OneDot0Dot1MerchantDivision(BaseModel):
    description: str
    r"""The description of the merchant division. **Nullable** for Transactions Details."""
    ...
    hook_type: Optional[OneDot0Dot1WebhooksType] = None
    r"""[Webhook events](https://help.bolt.com/developers/guides/webhooks/#transaction-hook-types) that trigger a notification to the URL.  **Note**:`newsletter_subscription` is only for merchant use cases.
    ...
    logo: Optional[OneDot0Dot1MerchantLogo] = None
    ...
    platform: Optional[OneDot0Dot1MerchantPlatform] = None
    r"""The type of platform being used for this merchant division."""
