    ...
    def query_webhooks(
        ...
        *,
        ...
        if server_url is not None:
            ...
            base_url = models.QUERY_WEBHOOKS_OP_SERVERS[0]
    ...
    def create_webhook(
        ...
        *,
        ...
        if server_url is not None:
            ...
            base_url = models.CREATE_WEBHOOK_OP_SERVERS[0]
    ...
    def delete_webhook(
        ...
        *,
        ...
        if server_url is not None:
            ...
            base_url = models.DELETE_WEBHOOK_OP_SERVERS[0]
    ...
    def get_webhook(
        ...
        *,
        ...
        if server_url is not None:
            ...
            base_url = models.GET_WEBHOOK_OP_SERVERS[0]
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.OneDot0Dot1Webhook, http_res)
        if utils.match_response(http_res, ["400", "403", "404"], "application/json"):
            response_data = unmarshal_json_response(
                errors.OneDot0Dot1ErrorsBoltAPIResponseData, http_res
            )
