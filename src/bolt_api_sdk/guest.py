...
class Guest(BaseSDK):
    def initialize(
        ...
        *,
        security: Union[
            models.GuestPaymentsInitializeSecurity,
            models.GuestPaymentsInitializeSecurityTypedDict,
        ],
        x_publishable_key: str,
        profile: Union[
            models.ThreeDot3Dot7ProfileCreationData,
            models.ThreeDot3Dot7ProfileCreationDataTypedDict,
        ],
        ...
        r"""Initialize a Bolt payment for guest shoppers
        ...
        if server_url is not None:
            ...
            base_url = models.GUEST_PAYMENTS_INITIALIZE_OP_SERVERS[0]
            url_variables = {
                "environment": "api-sandbox",
            }

        request = models.GuestPaymentsInitializeRequest(
            x_publishable_key=x_publishable_key,
            x_merchant_client_id=x_merchant_client_id,
            three_dot_3_dot_7_guest_payment_initialize_request=models.ThreeDot3Dot7GuestPaymentInitializeRequest(
                profile=utils.get_pydantic_model(
                    profile, models.ThreeDot3Dot7ProfileCreationData
                ),
                cart=utils.get_pydantic_model(cart, models.ThreeDot3Dot7Cart),
                payment_method=utils.get_pydantic_model(
                    payment_method, models.ThreeDot3Dot7PaymentMethodInput
                ),
            ),
        )
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.GuestPaymentsInitializeSecurity
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
                request.three_dot_3_dot_7_guest_payment_initialize_request,
                False,
                False,
                "json",
                models.ThreeDot3Dot7GuestPaymentInitializeRequest,
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="guestPaymentsInitialize",
                oauth2_scopes=None,
    ...
    def perform_action(
        ...
        *,
        security: Union[
            models.GuestPaymentsActionSecurity,
            models.GuestPaymentsActionSecurityTypedDict,
        ],
        x_publishable_key: str,
        id: str,
        ...
        r"""Finalize a pending guest payment
        ...
        :param security:
        :param x_publishable_key: The publicly shareable identifier used to identify your Bolt merchant division.
        :param id: The ID of the guest payment to operate on
        :param dot_tag:
        :param x_merchant_client_id: A unique identifier for a shopper's device, generated by Bolt. The value is retrieved with `Bolt.state.merchantClientId` in your frontend context, per-shopper. This header is required for proper attribution of this operation to your analytics reports. Omitting this header may result in incorrect statistics.
        ...
        if server_url is not None:
            ...
            base_url = models.GUEST_PAYMENTS_ACTION_OP_SERVERS[0]
            url_variables = {
                "environment": "api-sandbox",
            }

        request = models.GuestPaymentsActionRequest(
            x_publishable_key=x_publishable_key,
            x_merchant_client_id=x_merchant_client_id,
            id=id,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.GuestPaymentsActionSecurity
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="guestPaymentsAction",
                oauth2_scopes=None,
                security_source=get_security_from_env(security, models.Security),
            ),
            request=req,
