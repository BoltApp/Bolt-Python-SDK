...
class BoltOrders(BaseSDK):
    ...
    def create_order_token(
        ...
        *,
        request: Optional[
            Union[models.OneDot0Dot1OrderCreate, models.OneDot0Dot1OrderCreateTypedDict]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.OneDot0Dot1IOrderView:
        ...
        if server_url is not None:
            ...
            base_url = models.CREATE_ORDER_TOKEN_OP_SERVERS[0]

        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, Optional[models.OneDot0Dot1OrderCreate])
        request = cast(Optional[models.OneDot0Dot1OrderCreate], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, True, "json", Optional[models.OneDot0Dot1OrderCreate]
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.OneDot0Dot1IOrderView, http_res)
    ...
    def track_order(
        ...
        *,
        request: Optional[
            Union[
                models.OneDot0Dot1OrderTrackRequestBody,
                models.OneDot0Dot1OrderTrackRequestBodyTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.OneDot0Dot1OrderTrackResponse:
        ...
        if server_url is not None:
            ...
            base_url = models.TRACK_ORDER_OP_SERVERS[0]

        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, Optional[models.OneDot0Dot1OrderTrackRequestBody]
            )
        request = cast(Optional[models.OneDot0Dot1OrderTrackRequestBody], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[models.OneDot0Dot1OrderTrackRequestBody],
            ),
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.OneDot0Dot1OrderTrackResponse, http_res
            )
