...
class SubscriptionOrders(BaseSDK):
    def list(
        self,
        *,
        security: Union[
            models.ListSubscriptionOrdersSecurity,
            models.ListSubscriptionOrdersSecurityTypedDict,
        ],
    ...
    ) -> List[models.V1SubscriptionOrder]:
        r"""Get all subscription orders

        Retrieves a list of all subscription orders.

        :param security:
        :param subscription_ids: Comma-separated list of subscription IDs to filter orders.
        ...
        if server_url is not None:
            ...
            base_url = models.LIST_SUBSCRIPTION_ORDERS_OP_SERVERS[0]

        request = models.ListSubscriptionOrdersRequest(
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.ListSubscriptionOrdersSecurity
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="listSubscriptionOrders",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[models.V1SubscriptionOrder], http_res)
