...
class Plans(BaseSDK):
    def list(
        self,
        *,
        security: Union[models.GetPlansSecurity, models.GetPlansSecurityTypedDict],
        ...
        :param security:
        :param merchant_product_id: ID of the product to retrieve plans for.
        :param merchant_variant_id: ID of the product variant to retrieve plans for.
        ...
        if server_url is not None:
            ...
            base_url = models.GET_PLANS_OP_SERVERS[0]
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(security, models.GetPlansSecurity),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[models.V1Plan], http_res)
