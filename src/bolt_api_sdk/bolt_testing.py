...
class BoltTesting(BaseSDK):
    ...
    def test_shipping(
        ...
        *,
        request: Optional[
            Union[
                models.OneDot0Dot1MockTrackingInput,
                models.OneDot0Dot1MockTrackingInputTypedDict,
            ]
        ] = None,
        ...
        if server_url is not None:
            ...
            base_url = models.TEST_SHIPPING_OP_SERVERS[0]

        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, Optional[models.OneDot0Dot1MockTrackingInput]
            )
        request = cast(Optional[models.OneDot0Dot1MockTrackingInput], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[models.OneDot0Dot1MockTrackingInput],
            ),
    ...
    def create_testing_shopper_account(
        ...
        *,
        ...
        one_dot_0_dot_1_testing_account_request: Optional[
            Union[
                models.OneDot0Dot1TestingAccountRequest,
                models.OneDot0Dot1TestingAccountRequestTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.OneDot0Dot1TestingAccountDetails:
        ...
        :param one_dot_0_dot_1_testing_account_request:
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        if server_url is not None:
            ...
            base_url = models.CREATE_TESTING_SHOPPER_ACCOUNT_OP_SERVERS[0]

        request = models.CreateTestingShopperAccountRequest(
            x_publishable_key=x_publishable_key,
            one_dot_0_dot_1_testing_account_request=utils.get_pydantic_model(
                one_dot_0_dot_1_testing_account_request,
                Optional[models.OneDot0Dot1TestingAccountRequest],
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.one_dot_0_dot_1_testing_account_request,
                False,
                True,
                "json",
                Optional[models.OneDot0Dot1TestingAccountRequest],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.OneDot0Dot1TestingAccountDetails, http_res
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError("API error occurred", http_res, http_res_text)
    ...
    def get_test_credit_card_token(
        ...
        *,
        ...
        if server_url is not None:
            ...
            base_url = models.GET_TEST_CREDIT_CARD_TOKEN_OP_SERVERS[0]
        req = self._build_request(
            method="GET",
