...
class BoltConfiguration(BaseSDK):
    ...
    def get_merchant_callbacks(
        ...
        *,
    ...
    ) -> models.OneDot0Dot1MerchantCallbacksView:
        r"""Get Callback URLs
        ...
        if server_url is not None:
            ...
            base_url = models.GET_MERCHANT_CALLBACKS_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.OneDot0Dot1MerchantCallbacksView, http_res
            )
    ...
    def set_merchant_callbacks(
        ...
        *,
        request: Optional[
            Union[
                models.OneDot0Dot1MerchantCallbacksInput,
                models.OneDot0Dot1MerchantCallbacksInputTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        if server_url is not None:
            ...
            base_url = models.SET_MERCHANT_CALLBACKS_OP_SERVERS[0]

        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, Optional[models.OneDot0Dot1MerchantCallbacksInput]
            )
        request = cast(Optional[models.OneDot0Dot1MerchantCallbacksInput], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[models.OneDot0Dot1MerchantCallbacksInput],
            ),
            timeout_ms=timeout_ms,
        )
    ...
    def get_merchant_identifiers(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.OneDot0Dot1MerchantIdentifiersView:
        ...
        if server_url is not None:
            ...
            base_url = models.GET_MERCHANT_IDENTIFIERS_OP_SERVERS[0]
        req = self._build_request(
            method="GET",
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.OneDot0Dot1MerchantIdentifiersView, http_res
            )
