...
class BoltAccount(BaseSDK):
    ...
    def get_account(
        ...
        *,
    ...
    ) -> models.OneDot0Dot1AccountDetails:
        ...
        if server_url is not None:
            ...
            base_url = models.GET_ACCOUNT_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.OneDot0Dot1AccountDetails, http_res)
    ...
    def create_account(
        ...
        *,
        ...
        one_dot_0_dot_1_create_account_input: Optional[
            Union[
                models.OneDot0Dot1CreateAccountInput,
                models.OneDot0Dot1CreateAccountInputTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        :param one_dot_0_dot_1_create_account_input:
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        if server_url is not None:
            ...
            base_url = models.CREATE_ACCOUNT_OP_SERVERS[0]

        request = models.CreateAccountRequest(
            x_publishable_key=x_publishable_key,
            idempotency_key=idempotency_key,
            one_dot_0_dot_1_create_account_input=utils.get_pydantic_model(
                one_dot_0_dot_1_create_account_input,
                Optional[models.OneDot0Dot1CreateAccountInput],
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.one_dot_0_dot_1_create_account_input,
                False,
                True,
                "json",
                Optional[models.OneDot0Dot1CreateAccountInput],
    ...
    def update_account_profile(
        ...
        *,
        ...
        x_publishable_key: Optional[str] = None,
        one_dot_0_dot_1_update_profile: Optional[
            Union[
                models.OneDot0Dot1UpdateProfile,
                models.OneDot0Dot1UpdateProfileTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        :param security:
        :param x_publishable_key: The publicly viewable identifier used to identify a merchant division. This key is found in the Developer > API section of the Bolt Merchant Dashboard [RECOMMENDED].
        :param one_dot_0_dot_1_update_profile:
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        if server_url is not None:
            ...
            base_url = models.UPDATE_ACCOUNT_PROFILE_OP_SERVERS[0]

        request = models.UpdateAccountProfileRequest(
            x_publishable_key=x_publishable_key,
            one_dot_0_dot_1_update_profile=utils.get_pydantic_model(
                one_dot_0_dot_1_update_profile,
                Optional[models.OneDot0Dot1UpdateProfile],
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.one_dot_0_dot_1_update_profile,
                False,
                True,
                "json",
                Optional[models.OneDot0Dot1UpdateProfile],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.OneDot0Dot1ProfileView, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
    ...
    def add_address(
        ...
        *,
        ...
        x_publishable_key: Optional[str] = None,
        idempotency_key: Optional[str] = None,
        one_dot_0_dot_1_address_account: Optional[
            Union[
                models.OneDot0Dot1AddressAccount,
                models.OneDot0Dot1AddressAccountTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        :param x_publishable_key: The publicly viewable identifier used to identify a merchant division. This key is found in the Developer > API section of the Bolt Merchant Dashboard [RECOMMENDED].
        :param idempotency_key: A key created by merchants that ensures `POST` and `PATCH` requests are only performed once. [Read more about Idempotent Requests here](/developers/references/idempotency/).
        :param one_dot_0_dot_1_address_account:
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        if server_url is not None:
            ...
            base_url = models.ADD_ADDRESS_OP_SERVERS[0]

        request = models.AddAddressRequest(
            x_publishable_key=x_publishable_key,
            idempotency_key=idempotency_key,
            one_dot_0_dot_1_address_account=utils.get_pydantic_model(
                one_dot_0_dot_1_address_account,
                Optional[models.OneDot0Dot1AddressAccount],
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.one_dot_0_dot_1_address_account,
                False,
                True,
                "json",
                Optional[models.OneDot0Dot1AddressAccount],
    ...
    def delete_address(
        ...
        *,
        ...
        if server_url is not None:
            ...
            base_url = models.DELETE_ADDRESS_OP_SERVERS[0]
    ...
    def replace_address(
        ...
        *,
        ...
        metadata: OptionalNullable[
            Union[
                models.OneDot0Dot1ShopperMetadata,
                models.OneDot0Dot1ShopperMetadataTypedDict,
            ]
        ] = UNSET,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        if server_url is not None:
            ...
            base_url = models.REPLACE_ADDRESS_OP_SERVERS[0]

        request = models.ReplaceAddressRequest(
            id=id,
            x_publishable_key=x_publishable_key,
            idempotency_key=idempotency_key,
            one_dot_0_dot_1_address_account=models.OneDot0Dot1AddressAccount(
                company=company,
                country=country,
                ...
                metadata=utils.get_pydantic_model(
                    metadata, OptionalNullable[models.OneDot0Dot1ShopperMetadata]
                ),
            ),
        )
    ...
    def edit_address(
        ...
        *,
        ...
        if server_url is not None:
            ...
            base_url = models.EDIT_ADDRESS_OP_SERVERS[0]
    ...
    def detect_account(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.OneDot0Dot1V1AccountsView:
        r"""Detect Account
        ...
        if server_url is not None:
            ...
            base_url = models.DETECT_ACCOUNT_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.OneDot0Dot1V1AccountsView, http_res)
    ...
    def add_payment_method(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.OneDot0Dot1SavedCreditCardView:
        ...
        **Note**: Before using this API, the credit card details must be tokenized using Bolt's JavaScript library function, which is documented in [Install the Bolt Tokenizer](https://help.bolt.com/developers/references/bolt-tokenizer).
        ...
        if server_url is not None:
            ...
            base_url = models.ADD_PAYMENT_METHOD_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.OneDot0Dot1SavedCreditCardView, http_res
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError("API error occurred", http_res, http_res_text)
    ...
    def delete_payment_method(
        ...
        *,
        ...
        if server_url is not None:
            ...
            base_url = models.DELETE_PAYMENT_METHOD_OP_SERVERS[0]
