...
class BoltStatements(BaseSDK):
    ...
    def get_statements(
        ...
        *,
        request: Optional[
            Union[
                models.OneDot0Dot1StatementsViewRequestBody,
                models.OneDot0Dot1StatementsViewRequestBodyTypedDict,
            ]
        ] = None,
    ...
    ) -> models.OneDot0Dot1StatementsViewResponse:
        r"""Fetch a Statement
        ...
        if server_url is not None:
            ...
            base_url = models.GET_STATEMENTS_OP_SERVERS[0]

        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, Optional[models.OneDot0Dot1StatementsViewRequestBody]
            )
        request = cast(Optional[models.OneDot0Dot1StatementsViewRequestBody], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[models.OneDot0Dot1StatementsViewRequestBody],
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.OneDot0Dot1StatementsViewResponse, http_res
            )
